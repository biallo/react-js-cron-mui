...
export default function Cron(props) {
  ...
  return React.createElement("div", {
  ...
  }, React.createElement(FormControl, null, React.createElement(Period, _extends({
    ...
    readOnly: readOnly,
    shortcuts: shortcuts
  }, selectProps))), periodForRender === 'reboot' ? clearButtonNode : React.createElement(React.Fragment, null, periodForRender === 'year' && React.createElement(FormControl, null, React.createElement(Months, _extends({
    value: months,
    setValue: setMonths,
    locale: locale,
    className: className,
  ...
  }, selectProps))), (periodForRender === 'year' || periodForRender === 'month') && React.createElement(FormControl, null, React.createElement(MonthDays, _extends({
    value: monthDays,
    ...
    period: periodForRender
  }, selectProps))), (periodForRender === 'year' || periodForRender === 'month' || periodForRender === 'week') && React.createElement(FormControl, null, React.createElement(WeekDays, _extends({
    value: weekDays,
    ...
    readOnly: readOnly,
    period: periodForRender
  }, selectProps))), React.createElement("div", null, periodForRender !== 'minute' && periodForRender !== 'hour' && React.createElement(FormControl, null, React.createElement(Hours, _extends({
    value: hours,
    setValue: setHours,
    locale: locale,
    className: className,
    ...
    period: periodForRender
  }, selectProps))), periodForRender !== 'minute' && React.createElement(FormControl, null, React.createElement(Minutes, _extends({
    value: minutes,
    setValue: setMinutes,
    locale: locale,
    period: periodForRender,
